  ...
  return (
    <main className="relative min-h-screen bg-background font-serif text-foreground">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 py-16">
        ...
        {/* TODO: Contingut de matrius-en-cercle (Netlify/Codex) */}
        <div className="rounded-2xl border border-[#d8c4b3] bg-[#faf5ef] p-10 text-center">
          ...
          <h1 className="text-3xl font-medium tracking-wide text-[#6b5347]">Matrius en Cercle</h1>
          <p className="mt-3 text-xl italic text-[#8e6e60]">Espai grupal mensual (online)</p>
