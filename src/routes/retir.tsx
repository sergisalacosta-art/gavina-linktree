    ...
    <div className="rt">
      ...
      <header className="hero">
        <div className="hero-inner">
          ...
          <p className="hero-sub">Reconnecta amb la teva matriu<br />per viure en coherència</p>
        ...
        <section className="cream" id="pla">
          <div className="wrap">
            ...
            <div className="pre-event">
              <p style={{ margin: 0, fontWeight: 700, color: "var(--terra-fosc)" }}>Uns dies abans del retir, obrirem un grup de WhatsApp on :</p>
              <ul className="bullets">
        ...
        <section>
          <div className="wrap">
            ...
            <div className="bio-side">
              <div>
                <p className="lead" style={{ marginTop: 0 }}>Soc la Gavina i el meu gran despertar va començar fa tretze anys, quan vaig ser mare per primera vegada.</p>
